# Kalshi setup for NorthStar (US traders)
...
```bash
northstar kalshi              # list 15m BTC/ETH/SOL markets
northstar kalshi-dry          # one snapshot of signals
northstar kalshi-dry --duration 300   # watch for 5 minutes
```
...
5. Add to the NorthStar repo `.env` (never commit this file):
